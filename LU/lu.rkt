...
(define-syntax-case (define-jac DNAME)
  ...
  ;;;//---------------------------------------------------------------------
            (let* ([tmp1 (fr rho_i ijk3)]
              ...
              (DIAG0 d 0 (+ 1.0 (fl* dt 2.0 tds1)) 0.0 0.0 0.0 0.0)

              (RX123 1 (+ (fl* tx1 r43) ty1 tz1) tds2)
              (RX123 2 (+ (fl* ty1 r43) tx1 tz1) tds3) 
              (RX123 3 (+ (fl* tz1 r43) tx1 ty1) tds4)
